		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">Jan 25,2023 <span class="changelog-version">Lite Version 5.1.16</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('Added : Client Listout : In Content Repeater Option','tpebl').'</li>';		
							echo '<li>'.esc_html__('Added : Team Member : In Content Repeater Option','tpebl').'</li>';							
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">Jan 25,2023 <span class="changelog-version">Pro Version 5.1.5</span></div>';
						echo '<ul class="changelog-list">';	
							echo '<li>'.esc_html__('Added : Client Listout : In Content Repeater Option','tpebl').'</li>';
							echo '<li>'.esc_html__('Added : Testimonials : In Content Repeater Option','tpebl').'</li>';
							echo '<li>'.esc_html__('Added : Team Member : In Content Repeater Option','tpebl').'</li>';
						echo '</ul>';					
				echo '</div>';
